...
object DataLoader {
    ...
    fun getRequest(path: String,customCallBack: CustomerCallBack){
        val call = service.getRequest(path)
        call.enqueue(callBack(customCallBack)) // ინტერფეისი გადაეცემა
    }

    fun postRequest(path: String,parameters:MutableMap<String,String>,customCallBack: CustomerCallBack){
    ...
    private fun callBack(customCallBack: CustomerCallBack):Callback<String> = object : Callback<String>{
